...
export function MenuIcon({ open }: { open: boolean }) {
  const bar = "absolute left-0 block h-[1.8px] w-[18px] rounded-full bg-current transition-[transform,rotate,scale,translate] duration-300 ease-out motion-reduce:transition-none";
  return (
